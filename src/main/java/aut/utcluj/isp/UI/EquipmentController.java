...
public class EquipmentController {
    ...
    public Map<String, List<Equipment>> getEquipmentsGroupedByOwner() {
        ...
        for (Equipment equipment : equipmentList) {
            if (!equipmentsGroupedByOwner.containsKey(equipment.getCurrentOwner())) {
                equipmentsGroupedByOwner.put(equipment.getCurrentOwner(), new ArrayList<>());
            }
            equipmentsGroupedByOwner.get(equipment.getCurrentOwner()).add(equipment);
        }
